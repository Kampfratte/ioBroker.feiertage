...
var holidays = {
    ...
    wfbrueckentag:      {enabled: false, "en": "Bridge Day after holiday",    "de": "Brückentag nach Weiberfastnacht",                                                desc: "bridge day",  easterOffset: -51},
    ...
    itatderbefreiung:   {enabled: false, "en": "Liberation Day Italy",        "de": "Tag der Befreiung in Italien",   "ru": "день освобождения (Италия)",             desc: "calender",    date: "25.04", offset: 114},
    ...
    tderbefreiung:      {enabled: false, "en": "Liberation Day (new federal countries)", "de": "Tag der Befreiung (neue Bundesländer)","ru": "день освобождения (новые федеральные страны)",desc: "political",   date: "08.05", offset: 127},
    ...
    chbrueckentag:      {enabled: false, "en": "Bridge Day after holiday",    "de": "Brückentag nach Chr. Himmelfahrt",                                               desc: "bridge day",  easterOffset: 40},
    ...
    uweimpftag:         {enabled: true,  "en": "Vollschutz Impfung",          "de": "Vollschutz Impfung",             "ru": "Vollschutz Impfung",                     desc: "privat",      date: "20.07", offset: 200},
    flbrueckentag:      {enabled: false, "en": "Bridge Day after holiday",    "de": "Brückentag nach Fronleichnam",                                                   desc: "bridge day",  easterOffset: 61},
    suinationaltag:     {enabled: false, "en": "National Day Switzerland",    "de": "Nationalfeiertag in der Schweiz","ru": "национальный праздник в швейцарии",      desc: "political",   date: "01.08", offset: 211},
    friedensfest:       {enabled: false, "en": "Peace Festival",              "de": "Friedensfest",                   "ru": "???",                                    desc: "religion",    date: "08.08", offset: 219},
    mhimmelfahrt:       {enabled: false, "en": "Assumption of Mary",          "de": "Mariä Himmelfahrt",              "ru": "Вознесение Девы Марии",                  desc: "religion",    date: "15.08", offset: 226, comment_en: "(BY (not everywhere), SL)",                        comment_de: "(BY (nicht überall), SL)"},
    wkinder:            {enabled: false, "en": "World Children's Day",        "de": "Weltkindertag",                  "ru": "Всемирный день защиты детей",            desc: "calender",    date: "20.09", offset: 262, comment_en: "(Thuringia)",                                      comment_de: "(Thüringen)",                        comment_ru: "(Тюрингия)"},
    ...
    reformationstag:    {enabled: false, "en": "Reformation Day",             "de": "Reformationstag",                "ru": "День Реформации (Хэллоуин)",             desc: "religion",    date: "31.10", offset: 303, comment_en: "(BB, HB, HH, MV, NI, SA, SH, ST, TH)",             comment_de: "(BB, HB, HH, MV, NI, SA, SH, ST, TH)",            comment_ru: "(BB, HB, HH, MV, NI, SA, SH, ST, TH)"},
    ...
    bussbettag:         {enabled: true,  "en": "Penance Day",                 "de": "Buß- und Bettag",                "ru": "день покая́ния и моли́твы",                desc: "religion",    advent4Offset: -32,             comment_en: "(Saxony)", comment_de: "(Sachsen)", comment_ru: "(SN)"},
